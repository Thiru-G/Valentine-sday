...
// 36 images (use .avif - must match actual filenames in game-photos)
const images = [
      ...
      <AnimatePresence mode="wait">
        {step === 0 && (
          <motion.h2
            ...
            exit={{ opacity: 0 }}
          >
            Congratulations Bhavi! You have completed the game.
          </motion.h2>
        )}
        {step === 1 && (
          <motion.h2
          ...
          >
            ...
            <div className="absolute inset-0 grid grid-cols-6 opacity-10">
              {images.slice(0, 36).map((src, index) => (
                <div key={index} className="relative h-full w-full min-h-0 min-w-0">
